...
m5 <- plm(RDi_m_per_empl~ Management + lnfape+lnempltot+staff_with_college_degree, 
                      index = c("ciiu4"),
                      effect = "individual", 
                      model = "within",
                      data = totalog4)
...
#FE:No
m6<-lm(RDi_m_per_empl~ Management + lnfape+lnempltot+staff_with_college_degree,data =totalog4)
