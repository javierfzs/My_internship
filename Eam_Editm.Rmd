...
totalog4<-subset(totalog2,select=c(NORDEMP,log_Value_Added_per_Employee,Management,ciiu4,ciiu4_2_d,dpto,lnfape,lnempltot,staff_with_college_degree,profoversales,lnprofoversales,empltot,RDi_m_per_empl))
...
m19 <- plm(RDi_m_per_empl~ Management + lnfape+lnempltot+staff_with_college_degree, 
                      index = c("ciiu4"),
                      effect = "individual", 
                      model = "within",
                      data = totalog4)
...
#FE:yes, with ciiu4. Dependent Variable:RDi
m20 <- plm(RDi_m_per_empl~ Management + lnfape+lnempltot+staff_with_college_degree, 
                      index = c("dpto"),
                      effect = "individual", 
                      model = "within",
                      data = totalog4)
...
#FE:No
m21<-lm(RDi_m_per_empl~ Management + lnfape+lnempltot+staff_with_college_degree,data =totalog4)
...
stargazer(m13,m14,m15,m16,m17,m18,m19,m20,m21,
          ...
          dep.var.labels = c("Log(VA/Emp)","(Profits/sales)","RD+i/Emp"),#,
          model.names = FALSE,
