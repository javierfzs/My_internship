...
#Data Frame to Descriptive Statistics
...
kable(selasticity, col.names =c("Dependent Variable","Coefficient", "From 25pctl to 75pctl"),align = 'c', format = 'latex',caption = "Semi-elasticities from bottom to top")
...
# ALL FIRMS for homogeneous and Heterogeneous, using Ln(1+Exp)
...
pivotprodcomplex2018<-aggregate(list(prodcomplex2018$complex), by=list(prodcomplex2018$NORDEMP),FUN=mean,na.rm=TRUE)
colnames(pivotprodcomplex2018)[1] <- "NORDEMP"
colnames(pivotprodcomplex2018)[2] <- "meancomplex"

total<-merge(total,pivotprodcomplex2018,by="NORDEMP",all.x = TRUE)

g13_comp<-subset(total,select=c(NORDEMP,lncount_destiny,lncount_products,lncount_dest_prod,lnexport2018,lnexport2018_per_dest,lnexport2018_per_prod,lnexport2018_per_dest_prod,lntop_dest_prod,Management,dpto,lnfape,lnempltot,staff_with_college_degree,CIIU4,lnfape,size_3,size_2,lnwage_per_emp,meancomplex))
